...
train_df = pd.read_csv(os.path.join('data', 'posneg', 'train_norm.csv'))
test_df = pd.read_csv(os.path.join('data', 'posneg', 'test_norm.csv'))
...
# logistic regression
lm = LogisticRegression(penalty='l2', C=10, solver='liblinear')
lm_params = {
    'penalty': ['l1', 'l2'],
...
submission.to_csv(os.path.join('data', 'posneg', 'posneg.csv'), index=False)
